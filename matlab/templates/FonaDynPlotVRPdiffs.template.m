...
% THIS FUNCTION IS NOT YET REWRITTEN FOR FonaDyn version <:VRPMain.mVersion:>. 
...
minCycles = 1;
xmax = <:VRPDataVRP.nMaxMIDI:>; 	% can be <=96
xmin = <:VRPDataVRP.nMinMIDI:>;		% can be >=30
ymax = <:VRPDataVRP.nMaxSPL:>; 		% can be <=120
ymin = <:VRPDataVRP.nMinSPL:>;		% can be >=40
